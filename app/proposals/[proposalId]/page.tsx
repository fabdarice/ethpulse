                ...
                <div className="flex items-center justify-center mb-2">
                  ...
                  <span className="text-2xl font-bold">
                    {formatNumberWithCommas(
                      proposal
                        ? calculateTotalVotes(proposal?.aggregateVote)
                        : 0
                    )}{" "}
                    ETH
                  </span>
            ...
            <div className="space-y-6">
              <div className="text-center">
                <div className="flex items-center justify-center mb-2">
                  ...
                  <span className="text-2xl font-bold">
                    {proposal
                      ? calculateTotalVoters(proposal?.aggregateVote)
                      : 0}
                  </span>
                </div>
        ...
        {userVote ? (
          <div className="rounded-lg text-center gap-4 pb-6">
            <h3 className="text-xl mb-4 text-gray-600">
              You voted{" "}
              <span className="text-green-500">{userVote.voteOption}</span> with{" "}
              {parseFloat(userVote.numVotes ?? "0").toFixed(5)} ETH
            </h3>
            <Button
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                ...
                .<br />
                It only requires a wallet signature. Signing this transaction is
                free and will not cost you any gas.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-left">
              ...
              <AccordionContent>
                No, voting is completely free and does not require sending any
